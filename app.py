            ...
            with t3:
                ...
                if not idf.empty:
                    ...
                    with col_ins1:
                        ...
                        fig1 = px.bar(top_items, x='final_item_price', y='item_name', orientation='h', title="Top 10 Προϊόντα (€)", color_discrete_sequence=['#2ecc71'])
                        st.plotly_chart(fig1, use_container_width=True)
                        
                    with col_ins2:
                        # Sales by Method Pie
                        fig2 = px.pie(idf, values='final_item_price', names='method', title="Τζίρος ανά Μέθοδο Πληρωμής", color_discrete_map={'Μετρητά':'#f1c40f', 'Κάρτα':'#3498db'})
