...
st.markdown("""
    ...
    .stApp { 
        ...
        color: white;
        border: 8px solid #2ecc71 !important; /* Το πάχος και το χρώμα του πλαισίου */
        box-shadow: inset 0 0 20px rgba(46, 204, 113, 0.5); /* Εσωτερική λάμψη */
        margin: 0;
        padding: 0;
    }
        ...
        if res_s.data:
            ...
            with t1:
                ...
                if not tdf.empty:
                    ...
                    c2.markdown(f"<div class='report-stat'>💳 Κάρτα<div class='stat-val'>{c_t['final_item_price'].sum():.2f}€</div><div class='stat-desc'>({c_t['s_date'].nunique()} πράξεις)</div></div>", unsafe_allow_
