...
# --- 2. CONFIG & STYLE ---
st.set_page_config(page_title="CHERRY v14.0.52", layout="wide", page_icon="🍒")
...
if st.session_state.is_logged_out:
    ...
    # ΟΛΟΣ Ο ΚΩΔΙΚΑΣ ΕΔΩ ΕΙΝΑΙ ΣΩΣΤΑ INDENTED ΜΕΣΑ ΣΤΟ ELSE
    with st.sidebar:
        st.title("🍒 CHERRY v14.0.52")
