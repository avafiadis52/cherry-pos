...
st.markdown("""
    ...
    /* Tabs Styling - Light Gray for visibility */
    button[data-baseweb="tab"] p {
        color: #d3d3d3 !important;
        font-weight: bold !important;
    }
    
    /* Metrics Label Styling - Light Gray */
            ...
            with t2:
                ...
                if not p_df.empty:
                    ...
                    for d_day in sorted(p_df['ΗΜΕΡΟΜΗΝΙΑ'].unique(), reverse=True):
                        ...
                        sc1.markdown("<div class='report-stat' style='padding:10px;'>💵 Μετρητά<div class='stat-val' style='font-size:18px;'>{:.2f}€</div><div class='stat
