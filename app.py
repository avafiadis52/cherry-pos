...
# --- 3. CONFIG & STYLE (Version v14.2.58) ---
st.set_page_config(page_title="CHERRY v14.2.58", layout="wide", page_icon="🍒")
            ...
            with t2:
                ...
                if not pdf.empty:
                    ...
                    for day in sorted(pdf['ΗΜΕΡΟΜΗΝΙΑ'].unique(), reverse=True):
                        ...
                        dm_t = day_df[day_df['method'] == 'Μετρητά']
                        dc_t = day_df[day_df['method'] == 'Κάρτα']
                        ...
                        sc3.markdown("<div class='report-stat' style='padding:10px;'>📉 Εκπτώσεις<div class='stat-val' style='font-size:18px; color:#e74c3c;'>{:.2f}€</div></div>".format(day_df['discount'].sum()), unsafe_allow_html=True)
