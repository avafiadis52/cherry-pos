...
# --- 2. CONFIG & STYLE ---
st.set_page_config(page_title="CHERRY v14.0.16", layout="wide", page_icon="🍒")
...
st.markdown("""
    ...
    <audio id="cash_register" src="https://www.soundjay.com/misc/sounds/cash-register-purchase-1.mp3" preload="auto"></audio>
    <audio id="error_beep" src="https://www.soundjay.com/buttons/beep-01a.mp3" preload="auto"></audio>
    """, unsafe_allow_html=True)
...
def play_audio_js(audio_id):
    """Παίζει τον ήχο με μικρή καθυστέρηση για αποφυγή clipping"""
