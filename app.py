...
# --- 3. CONFIG & STYLE (Version v14.2.00) ---
st.set_page_config(page_title="CHERRY v14.2.00", layout="wide", page_icon="🍒")
        ...
        if res.data:
            ...
            with t2:
                ...
                if not pdf.empty:
                    ...
                    c3.markdown(f"""<div class='report-stat'>📉 Εκπτώσεις<div class='
