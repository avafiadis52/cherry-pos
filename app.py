...
# --- 3. CONFIG & STYLE (Version v14.2.45) ---
st.set_page_config(page_title="CHERRY v14.2.45", layout="wide", page_icon="🍒")
        ...
        with cl:
            if st.session_state.selected_cust_id is None:
                ...
                if bc and supabase:
                    ...
                    if res.data: 
                        val = -float(res.data[0]['price']) if st.session_state.return_mode else
