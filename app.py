...
# --- 3. CONFIG & STYLE (Version v14.2.14) ---
st.set_page_config(page_title="CHERRY v14.2.14", layout="wide", page_icon="🍒")
...
if st.session_state.is_logged_out:
    ...
    if view == "🛒 ΤΑΜΕΙΟ":
        ...
        if res_s.data:
            ...
            st.download_button("📥 BACKUP ALL SALES (CSV)", data=csv_backup, file_name=
