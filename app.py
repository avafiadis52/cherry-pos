...
# --- 2. CONFIG & STYLE ---
st.set_page_config(page_title="CHERRY v14.0.34", layout="wide", page_icon="🍒")
...
if view == "🛒 ΤΑΜΕΙΟ":
    ...
    with cl:
        if st.session_state.selected_cust_id is None:
            ...
            # Λίστα καλαθιού με κλήση play_sound ακριβώς όπως στο λάθος barcode
